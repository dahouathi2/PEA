...
class Model(nn.Module,VertexModel):
    ...
    def train_model(self, train_loader, val_loader, test_loader, accelerator, path):
        ...
        train_loader, val_loader, test_loader, self, model_optim, scheduler = accelerator.prepare(
            train_loader, val_loader, test_loader, self, model_optim, scheduler)
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in tqdm(enumerate(train_loader)):
                ...
                if self.args.use_amp:
                    with torch.cuda.amp.autocast():
                        ...
                        batch_y = batch_y[:, -self.args.pred_len:, f_dim:].to(accelerator.device)
            ...
            vali_loss, vali_mae_loss = vali(self.args, accelerator, self,None, val_loader, criterion, mae_metric)
            test_loss, test_mae_loss = vali(self.args, accelerator, self,None, test_loader, criterion, mae_metric)
            accelerator.print(
